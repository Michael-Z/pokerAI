...
for k in range(3,9):
    ...
    poker_c = pd.read_csv('data_engineered/subsets/River-True.csv', header=None, names=fs['River-True'])
    ...
    # get data
    del poker_c
    poker_p = pd.read_csv('data_engineered/subsets/River-True.csv', header=None, names=fs['River-True'])
